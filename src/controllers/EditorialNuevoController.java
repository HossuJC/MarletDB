 ...
 */
public class EditorialNuevoController implements Initializable {
    ...
    private void guardarRegistro(ActionEvent event) {
        try {
            String sql = "{call nuevo_registro_editorial(?,?,?,?,?,?,?)}";
            ...
            stmt.setFloat(7, (!txtDescuento.getText().equals("")) ? Float.valueOf(txtDescuento.getText()) : null);
            stmt.execute();
